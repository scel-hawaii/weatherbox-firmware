/*******************************
 *
 * File: gs_dev_eeprom_node_address.cpp
 *
...
/******************************
 *
 * Name:        gs_dev_eeprom_node_address_open
 * Returns:     Nothing
 * Parameter:   Nothing
...
/******************************
 *
 * Name:        gs_dev_eeprom_node_address_read
 * Returns:     Nothing
...
/******************************
 *
 * Name:        gs_dev_eeprom_node_address_test
 * Returns:     Nothing
 * Parameter:   Nothing
...
void gs_dev_eeprom_node_address_test(void){
    ...
    Serial.println((int) gs_dev_eeprom_node_address_read());
}
