/*
    ...
    This file contains a base model for use with testing firmware for
    the Smart Campus Energy Lab 'weatherbox' platform. It generates a
    .elf file that accepts an argument to a .ihex file that contains
    a bootloader.

 	This file was written using the simavr projects and borrows from
    the simduino example. See here for more details:
